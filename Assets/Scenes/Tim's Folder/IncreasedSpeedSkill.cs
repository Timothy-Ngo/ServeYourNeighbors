...
public class IncreasedSpeedSkill : Skill
{
    ...
    {
        return Upgrades.inst.numTables >= requiredNumTables && Currency.inst.AbleToWithdraw(skillCost);
    }
    ...
    public override void Confirm()
    {
        if (CheckRequirements())
        {
            ...
            //TODO: Need to make the button non interactable and taken out so the player can't repeatedly buy the same skill
        }
        else
        {
