...
public class Player_Interaction_QT_Event : MonoBehaviour {
    ...
    [Header("-----SCRIPTS----")] 
    Cooking_QT_Event cooktopScript;
    ...
    private void OnTriggerEnter2D(Collider2D collision) {
        ...
        if(collision.tag == "Cooktop") { //&& !cooktopScript.IsCooking()) {
            ...
            cooktopRange = true;
            cooktopScript = collision.gameObject.transform.GetComponent<Cooking_QT_Event>();
        }
