...
public class PickupSystemObjects : MonoBehaviour
{
    public static PickupSystemObjects inst;
    private void Awake()
    {
        inst = this; 
    }
    ...
    [SerializeField] private bool holdingIngredient = false;
    [SerializeField] private bool holdingTopping = false;
    [SerializeField] private bool holdingDish = false;
    [SerializeField] private bool holdingFoodie = false;
    ...
    public void PickUpIngredient(IngredientBoxObjects ingredientBoxScript)
    {
